//26/04/2021
/*A step of a tortoise in search of happiness and true act of goodwill*/
//confidence and consistency are key weapons
//Practice Hard to build confidence
...
ll n=100000;
ll quicknum[100005], mergenum[100005], stlnum[100005],radixnum[100005],anazumm[100005],bnazumm[100005],lista[100005],listb[100005];
char listch[100005];
...
ll t[100005],tag[100005],natural[100005];
ll ta; 
...
void GetBPoint(ll aa[],ll bb[],ll n,ll &m)
 {
    ...
    while(1){
        ...
        if(xty){
            ds++;
            while(xr+1<=End&&aa[xr+1]>=aa[xr]) xr++;
        } 
        else{
                as++;
                while(xr+1<=End&&aa[xr+1]<=aa[xr]) xr++;
    ...
    cout << "total dissinding strip: " << ds << endl;
    cout << "total asscending strip: " << as << endl;
